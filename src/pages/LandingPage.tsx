      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-indigo-400 to-pink-400 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem] dark:from-indigo-700 dark:to-pink-700"
          />
        </div>
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-indigo-400 to-pink-400 opacity-30 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem] dark:from-indigo-700 dark:to-pink-700"
          />
        </div>
      </div>
    </div>
