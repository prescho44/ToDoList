        ...
        <form onSubmit={signUpNewUser} className="space-y-6">
          <div>
            ...
            <input
              ...
              className="mt-2 block w-full rounded-md border-gray-300 bg-gray-700 px-3 py-2 text-gray-900 shadow-sm focus:border-indigo-600 focus:ring-indigo-600 sm:text-sm dark:text-white"
            />
          </div>
